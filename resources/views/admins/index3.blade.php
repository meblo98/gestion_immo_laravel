    ...
    <div class="container mt-5 p-5">
        ...
        <form method="POST" action="{{ route('modification', $biens->id) }}" method="POST">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" name="nom" class="form-control" value="{{ $biens->nom }}" placeholder="Titre"
                    aria-label="Username">
                <span class="input-group-text">Categorie</span>
                <select class="form-select" value="{{ $biens->categorie }}" name="categorie"
                    aria-label="Default select example">
                    <option selected value="{{ $biens->categorie }}">{{ $biens->categorie }}</option>
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" name="localisation" value="{{ $biens->localisation }}" class="form-control"
                    placeholder="Titre" aria-label="Username">
                <span class="input-group-text">Status</span>
                <select class="form-select" name="statut" value="{{ $biens->statut }}" aria-label="Default select example">
                    <option selected value="{{ $biens->statut }}">{{ $biens->statut }}</option>
            ...
            <div class="input-group mb-3">
                ...
                <input type="number" name="prix" class="form-control" value="{{ $biens->prix }}" placeholder="prix"
                    aria-label="prix">
            </div>
